...
import {
  AnimatedVuew,
  renderWithAnimatedVuew,
} from "@/components/ui/AnimatedVuew";
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="font-bold text-foreground leading-[1.02] text-6xl md:text-7xl lg:text-8xl"
            >
              my-
              <AnimatedVuew delay={0} />
            </motion.h2>
            <motion.p
              ...
              className=" text-2xl md:text-3xl text-foreground italic border-l-2 border-foreground/30 pl-4"
            >
              Your Growth.
            </motion.p>
            <motion.p
            ...
            >
              <AnimatedVuew delay={0.8} /> the world's foremost primary sources,
              across countries and disciplines — distilling them into a single,
              structured feed in order to help you grow professionally and
              intellectually.
            </motion.p>
            <motion.p
              ...
              className="text-muted-foreground/70  text-base max-w-md leading-relaxed"
            >
              Taking into account the advice of the world's best minds regarding
              how the news feed composition should be to suit your best
              interests.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
            ...
            >
              Reuters · BBC News · WSJ · NYT · The Hindu · Al Jazeera ·
              Financial Times
            </motion.p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2 space-y-8">
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className=" text-5xl md:text-6xl lg:text-7xl font-bold text-foreground leading-[1.02] whitespace-nowrap"
            >
              multi-
              <AnimatedVuew delay={0} />
            </motion.h2>
            ...
            <motion.p
              ...
              className="text-muted-foreground  text-lg md:text-xl max-w-md leading-relaxed"
            >
              <AnimatedVuew delay={0.8} /> how the same incident is perceived
              across different regions of the world in order to understand and
              remove Biasness of any incident.
            </motion.p>
            <motion.div
              initial="hidden"
              whileInView="visible"
              ...
              {[
                ...
                >
                  <div>
                    ...
                    <div className="text-[10px] text-muted-foreground/50 font-sans mt-0.5">
                      {item.src}
                    </div>
                  </div>
                </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className=" text-6xl md:text-7xl lg:text-8xl font-bold text-foreground leading-[1.02]"
            >
              meta-
              <AnimatedVuew delay={0} />
            </motion.h2>
            ...
            <motion.p
              ...
              className="text-muted-foreground  text-lg md:text-xl max-w-md leading-relaxed"
            >
              <AnimatedVuew delay={0.8} /> how a story evolved over the course
              of time in order to take the current form as it is.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 12 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-muted-foreground/70  text-base max-w-md leading-relaxed"
            >
              <AnimatedVuew delay={1.6} /> the intent or meta-layer of the
              story.
            </motion.p>
          </div>
          ...
          <div className="flex justify-center items-center gap-10">
            ...
            <div className="hidden lg:flex flex-col relative py-10 min-h-[360px]">
              <svg
                className="absolute left-[3px] top-0 bottom-0 w-[2px] h-full"
...
const experts = [
  {
    role: "Economist",
    quote:
      "Trade deficits signal structural imbalance, not temporary volatility.",
  },
  {
    role: "Policy Expert",
    quote: "Regulatory gaps allow capital to flow unchecked across borders.",
  },
  {
    role: "Scientist",
    quote:
      "Climate data confirms feedback loops are accelerating beyond projections.",
  },
];
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            >
              <AnimatedVuew delay={0.8} /> the story from the lens of a
              technocrat.
            </motion.p>
              ...
              {experts.map((e, i) => (
                <GlassCard key={i} delay={i * 0.12}>
                  <div className="flex items-start gap-4">
                    <span className="text-[9px] font-sans text-muted-foreground/30 pt-1 shrink-0">
                      {String(i + 1).padStart(2, "0")}
                    </span>
                    <div>
                      <p className="text-[9px] uppercase tracking-[0.18em] text-muted-foreground font-sans mb-1.5">
                        {e.role}
                      </p>
...
const storyLayers = [
  {
    label: "Summary",
    desc: "The essential facts in under 60 seconds.",
    color: "from-foreground/5 to-foreground/2",
  },
  {
    label: "Perspectives",
    desc: "Geopolitical, economic, and human viewpoints.",
    color: "from-foreground/4 to-foreground/1",
  },
  {
    label: "Timeline",
    desc: "Historical context mapped in sequence.",
    color: "from-foreground/3 to-foreground/1",
  },
  {
    label: "Expert Insights",
    desc: "Verified analysis from domain specialists.",
    color: "from-foreground/2 to-transparent",
  },
];
...
function StoryLayerRow({
  ...
  return (
    ...
    >
      <span className="text-[9px] font-sans text-muted-foreground/30 pt-1 w-5 shrink-0">
        {String(index + 1).padStart(2, "0")}
      </span>
      <div>
        <p
          className={` text-base transition-colors duration-300 ${hovered ? "text-foreground" : "text-foreground/80"}`}
        >
          {layer.label}
        </p>
    ...
    <div className="relative w-full flex justify-center">
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-6">
          <div
            className="w-1.5 h-1.5 rounded-full bg-red-600/70"
            aria-hidden="true"
          />
          <p className="text-[9px] uppercase tracking-[0.2em] text-muted-foreground font-sans">
            Story structure
          </p>
        </div>
        ...
        {storyLayers.map((layer, i) => (
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div
                  ...
                  style={{
                    background:
                      i === 0 ? "rgba(196,30,58,0.7)" : "rgba(128,128,128,0.4)",
                  }}
                  aria-hidden="true"
                />
                <p
                  className={`text-[9px] uppercase tracking-[0.18em] font-sans ${i === 0 ? "text-foreground/70" : "text-muted-foreground/60"}`}
                >
                  {layer.label}
                </p>
              </div>
            ...
            {i <= 1 && (
              <p
                className={` text-xs mt-2 leading-relaxed ${i === 0 ? "text-foreground/70" : "text-muted-foreground/50"}`}
              >
                {layer.desc}
              </p>
            )}
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            ...
            <motion.p
              ...
              className="text-muted-foreground  text-lg leading-relaxed max-w-md"
            >
              No tab-switching. No fragmentation. Every story arrives structured
              — ready to read, understand, and apply.
            </motion.p>
  ...
  return (
    ...
    >
      <div className="px-4 py-4 flex items-center gap-3">
        <span className="text-sm text-muted-foreground/40 font-sans line-through decoration-muted-foreground/20">
          {item.before}
        </span>
      </div>
      <div className="px-4 py-4 flex items-center gap-3 border-l border-border/30">
        <motion.div
          animate={
            hovered ? { width: 16, opacity: 1 } : { width: 8, opacity: 0.4 }
          }
          className="h-px bg-foreground shrink-0"
        />
        <span
          className={`text-sm font-sans transition-colors duration-300 ${hovered ? "text-foreground" : "text-foreground/70"}`}
        >
          {item.after}
        </span>
      </div>
...
function ChaosToCalm() {
  ...
  return (
    <div
      className="glass-skeu relative w-full mx-auto p-6"
      style={{ maxWidth: 500 }}
    >
      {/* Ambient glow */}
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 75% 50%, rgba(196,30,58,0.05) 0%, transparent 60%)",
        }}
        aria-hidden="true"
      />
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            ...
            <motion.p
              ...
              className="text-muted-foreground  text-lg leading-relaxed max-w-md"
            >
              Engineered around reduced cognitive load — no algorithmic
              amplification, no sensationalism, no tab overload. Structured
              clarity.
            </motion.p>
            ...
            <div className="space-y-0">
              ...
              <div className="grid grid-cols-2 border-t border-border/40">
                <div className="px-4 py-2">
                  <span className="text-[9px] uppercase tracking-widest text-muted-foreground/30 font-sans">
                    Elsewhere
                  </span>
                </div>
                <div className="px-4 py-2 border-l border-border/30">
                  <span className="text-[9px] uppercase tracking-widest text-foreground/40 font-sans">
                    mVuew
                  </span>
                </div>
              </div>
